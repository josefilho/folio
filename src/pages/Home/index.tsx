...
import { Container, Text, Image, TextHighlight } from './styles';
    ...
    <>
      <Container>
        <Text>
          ...
          <TextHighlight> Ciência da Computação</TextHighlight> na Universidade
          ...
          <br />
          <br />
          Fui participante do <TextHighlight>
            Bootcamp GoStack 14
          </TextHighlight>{' '}
          da Rocketseat 💜.
        </Text>
